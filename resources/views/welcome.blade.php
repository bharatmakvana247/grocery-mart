                    ...
                    <div class="content content-full">
                        <div class="row justify-content-center">
                            <div class="col-md-6 py-3 text-center">
                                ...
                                <a class="btn btn-dark" href="{{ route('admin.login') }}">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/admin/js/plugins/jquery-countdown/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('assets/admin/js/pages/op_coming_soon.min.js') }}"></script>
@endsection
