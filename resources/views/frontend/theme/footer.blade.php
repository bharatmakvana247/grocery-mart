    ...
    <div class="container">
        ...
        <div class="agile-sometext">
            ...
            <div class="sub-some child-momu">
                ...
                <ul>
                    <li>
                        <img src="{{ asset('assets/front/images/pay2.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay5.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay1.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay4.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay6.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay3.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay7.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay8.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets/front/images/pay9.png') }}" alt="">
                    </li>
                </ul>
            </div>
        </div>
