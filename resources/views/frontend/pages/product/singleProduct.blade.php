            ...
            <div class="col-md-5 single-right-left ">
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="{{ url("storage/productImage/$single_product->product_image") }}">
                                <div class="thumb-image">
                                    <img src="{{ url("storage/productImage/$single_product->product_image") }}"
                                        data-imagezoom="true" class="img-responsive" alt="">
                                </div>
                            </li>
                            <li data-thumb="{{ asset('assets/front/images/si2.jp') }}g">
                                <div class="thumb-image">
                                    <img src="{{ asset('assets/front/images/si2.jpg') }}" data-imagezoom="true"
                                        class="img-responsive" alt="">
                                </div>
                            </li>
                            <li data-thumb="{{ asset('assets/front/images/si3.jp') }}g">
                                <div class="thumb-image">
                                    <img src="{{ asset('assets/front/images/si3.jpg') }}" data-imagezoom="true"
                                        class="img-responsive" alt="">
                                </div>
                            </li>
                        </ul>
                ...
                <ul id="flexiselDemo1">
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single.html">
                                    <img src="{{ asset('assets/front/images/s1.jpg') }}" alt="">
                                </a>
                            </div>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single.html">
                                    <img src="{{ asset('assets/front/images/s4.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single.html">
                                    <img src="{{ asset('assets/front/images/s2.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single2.html">
                                    <img src="{{ asset('assets/front/images/s3.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single.html">
                                    <img src="{{ asset('assets/front/images/s8.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single2.html">
                                    <img src="{{ asset('assets/front/images/s6.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single.html">
                                    <img src="{{ asset('assets/front/images/s5.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
                    ...
                    <li>
                        <div class="w3l-specilamk">
                            <div class="speioffer-agile">
                                <a href="single2.html">
                                    <img src="{{ asset('assets/front/images/s9.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-name-w3l">
                                <h4>
