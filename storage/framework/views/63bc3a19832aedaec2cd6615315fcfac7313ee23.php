    ...
    <div class="container">
        ...
        <div class="footer-info w3-agileits-info">
            ...
            <div class="col-sm-2 footer-grids  w3l-socialmk">
                ...
                <div class="agileits_app-devices">
                    ...
                    <a href="#">
                        <img src="<?php echo e(asset('assets/front/images/1.png')); ?>" alt="">
                    </a>
                    <a href="#">
                        <img src="<?php echo e(asset('assets/front/images/2.png')); ?>" alt="">
                    </a>
                    <div class="clearfix"> </div>
                </div>
            </div>
        ...
        <div class="agile-sometext">
            ...
            <div class="sub-some child-momu">
                ...
                <ul>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay2.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay5.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay1.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay4.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay6.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay3.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay7.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay8.png')); ?>" alt="">
                    </li>
                    <li>
                        <img src="<?php echo e(asset('assets/front/images/pay9.png')); ?>" alt="">
                    </li>
                </ul>
            </div>
        </div>
...
<div class="copy-right">
    <div class="container">
        <p>© 20123 Grocery Shoppy. All rights reserved | Design by
            <a href="http://w3layouts.com"> W3layouts.</a>
        </p>
    </div>
</div>
<?php /**PATH D:\laravel_panel\resources\views/frontend/theme/footer.blade.php ENDPATH**/ ?>